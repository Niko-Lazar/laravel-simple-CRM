    ...
    <div class="container">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="rendered-form">
                <div class="">
                    <h1 access="false" id="control-6169232">Add User</h1></div>
                ...
                <div class="formbuilder-select form-group field-role mt-2">
                    ...
                    <select class="form-control" name="user_id" id="role">
                        ...
                        @foreach($superiors as $superior)
                            <option
                                value="{{ $superior->id }}"
                                id="role-1"
                                {{ (old('user_id')== $superior->id) ? 'selected' : null }}
                    ...
                    <div class="formbuilder-button form-group field-submit mt-4">
                        <button type="submit" class="btn-info btn" name="submit" access="false" style="info" id="submit">Add User</button>
                    </div>
            </div>
            @if($errors->any())
                <ul class="mt-3">
