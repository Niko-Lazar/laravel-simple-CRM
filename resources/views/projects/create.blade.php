        ...
        <form method="POST" action="/projects">
            ...
            <div class="rendered-form">
                ...
                <div class="formbuilder-text form-group field-title">
                    ...
                    <input type="text" placeholder="title" class="form-control" name="title" access="false" id="title" title="Project title" required="required" aria-required="true">
                </div>
                ...
                <div class="formbuilder-text form-group field-description">
                    ...
                    <input type="text" placeholder="description" class="form-control" name="description" access="false" id="description" title="project description" required="required" aria-required="true">
                </div>
                ...
                <div class="formbuilder-date form-group field-deadline">
                    ...
                    <input type="date" class="form-control" name="deadline" access="false" id="deadline" required="required" aria-required="true">
                </div>

                <div class="formbuilder-radio-group form-group field-status">
                    <label for="status" class="formbuilder-radio-group-label">Status<span class="formbuilder-required">*</span></label>
                    <div class="radio-group">
                        <div class="formbuilder-radio">
                            <input name="status" access="false" id="status-0" required="required" aria-required="true" value="0" type="radio" checked="checked">
                            <label for="status-0">In progress</label>
                        </div>
                        <div class="formbuilder-radio">
                            <input name="status" access="false" id="status-1" required="required" aria-required="true" value="1" type="radio">
                            <label for="status-1">Finished</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="formbuilder-button form-group field-submit">
                    <button type="button" class="btn-info btn mt-4" name="submit" access="false" style="info" id="submit">Add project</button>
                </div>
            </div>
